...
export default function TradingInterface() {
  ...
  return (
    <div className="w-full max-w-6xl rounded-2xl border border-gray-700 text-white p-4 mx-auto">
                ...
                <div className="flex items-center justify-between gap-2">
                  ...
                  <div className="flex items-center">
                    <input
                      ...
                      className="bg-transparent text-right text-xl text-[#edb546] outline-none w-24 sm:w-32"
                    />
          ...
          <div className="mb-4 flex flex-wrap items-center justify-between gap-2">
            {percentages.map((percent) => (
              <div key={`buy-${percent}`} className="flex flex-col items-center">
                ...
                />
                <span className="mt-1 text-sm text-white">{percent}%</span>
              </div>
            ))}
          </div>
